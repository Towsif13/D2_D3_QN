...
np.savetxt("scores_d2qn_reward-50"+str(args.env)+".txt", scores_ddqn_np)
...
train_info_file = open('train_info_reward_-50'+str(args.env)+'.json', 'w')
...
plt.ylabel('Score')
plt.xlabel('Episode')
plt.savefig('graph_reward'+str(args.env)+'.png')
plt.show()
